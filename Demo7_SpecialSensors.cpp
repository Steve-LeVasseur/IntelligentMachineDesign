/*
 * IMD_Demo7_SpecialSensors.cpp
 *
 * Created: 4/4/2023 10:55:44 AM
 * Author : 13305
 */ 
...
volatile uint8_t FirstLineStr[21] =  "Mic: X XXXX         ";
volatile uint8_t SecondLineStr[21] = "Motion: X           ";
volatile uint8_t ThirdLineStr[21] =  "deez                ";
volatile uint8_t FourthLineStr[21] = "nuts                ";
...
//Select Analog Port 0 and Internal Reference Voltage;
	...
	DDRD = (0<<PIND0)|(0<<PIND1)|(1<<PIND2)|(1<<PIND3)|(1<<PIND7);
...
//	}
	...
	if (display_counter>2){
		...
		else {FirstLineStr[5] = 0+48;}
		
		FirstLineStr[7] = (combined/1000)+48;
		combined = combined % 1000;
		FirstLineStr[8] = (combined/100)+48;
		combined = combined % 100;
		FirstLineStr[9] = (combined/10)+48;
		combined = combined % 10;
		FirstLineStr[10] = combined+48;
			
		
			
		if (PIND&(1<<PIND1))
		{
			SecondLineStr[8] = 1+48;
		}
		else {SecondLineStr[8] = 0+48;}
